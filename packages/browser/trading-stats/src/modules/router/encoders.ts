...
export function decodeParams(
    ...
    return {
        ...
        [ETradingStatsRouteParams.QuoteAssetsInclude]: mapToNumberArray(params.quoteAssetsInclude),
        ...
        [ETradingStatsRouteParams.QuoteAssetsExclude]: mapToNumberArray(params.quoteAssetsExclude),
...
export function encodeParams(params: TAllTradingStatsRouteParams): TEncodedTradingStatsRouteParams {
    ...
    (
        [
            ...
            ETradingStatsRouteParams.QuoteAssetsInclude,
            ...
            ETradingStatsRouteParams.QuoteAssetsExclude,
