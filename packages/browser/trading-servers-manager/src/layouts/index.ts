...
import { createGlobalLayout, createGlobalLayoutWithoutMenu } from './global';
import {
...
export const DEFAULT_LAYOUTS: TPageLayouts = {
    ...
    [ELayoutIds.GlobalNoMenu]: {
        id: ELayoutIds.GlobalNoMenu,
        value: createGlobalLayoutWithoutMenu(),
        version: 1,
    },
