...
import {
    ComponentsListView,
    TComponentDataType,
} from '@frontend/trading-servers-manager/src/components/Menu/Components/view';
import { useGetContextMenuItems } from '@frontend/trading-servers-manager/src/components/Menu/useGetContextMenuItems';
import { useCurrentRobot } from '@frontend/trading-servers-manager/src/hooks/useCurrentRobot';
