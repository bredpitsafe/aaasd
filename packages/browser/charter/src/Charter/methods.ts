import { Milliseconds, Seconds, Someseconds } from '@frontend/common/src/types/time';
import { plus } from '@frontend/common/src/utils/math';
import { milliseconds2seconds } from '@frontend/common/src/utils/time';

import { TSeriesId } from '../../lib/Parts/def';
import { MouseClosestPointsController } from '../services/MouseClosestPointsController';
import { IContext, TContextState } from '../types';
