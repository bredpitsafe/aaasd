...
import { MouseController } from '@frontend/charter/src/services/MouseController';
import {
...
import { TTestChartProps } from './defs';
import { getDataGenerator } from './generatePoints';
import { casesMap, ECaseName } from './testChartsData';
