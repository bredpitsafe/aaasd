...
import { FieldInfo, Json2CsvTransform } from 'json2csv';
...
export function TableLabelExportData<T extends Record<string, unknown>>(
    ...
    return (
        <>
            <TableLabelButton
                {...createTestProps(ETableTabFilterSelectors.CVSButton)}
                icon={icon}
                title={`${title}\n${altModeTitle}`}
            ...
            <TableLabelButton
                {...createTestProps(ETableTabFilterSelectors.TSVButton)}
                icon={icon}
                title={`${title}\n${altModeTitle}`}
            ...
            <TableLabelButton
                {...createTestProps(ETableTabFilterSelectors.JSONButton)}
                icon={icon}
                title={title}
