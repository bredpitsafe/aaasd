...
import { ModuleSubscribeToIndicatorsSnapshot } from '../../modules/actions/indicators/snapshot';
import type { TSocketURL } from '../../types/domain/sockets';
import type { ISO } from '../../types/time';
import { EMPTY_ARRAY } from '../../utils/const';
import { mapGet } from '../../utils/map';
...
export function useLastIndicatorsMap(
    ...
    const subscribe = useModule(ModuleSubscribeToIndicatorsSnapshot);
