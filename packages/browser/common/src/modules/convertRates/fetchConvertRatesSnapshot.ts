...
} from '@bhft/bff/src/modules/tradingDataProvider/schemas/FetchConvertRatesSnapshot.schema.ts';
...
export const descriptor = createRemoteProcedureDescriptor<
    TFetchConvertRatesSnapshotRequestPayload,
    TFetchConvertRatesSnapshotResponsePayload
>()(EServerRemoteProcedureName.FetchConvertRatesSnapshot, ERemoteProcedureType.Request);
