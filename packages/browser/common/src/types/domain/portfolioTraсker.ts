...
import { TStructurallyCloneableObject } from '../serialization';
import { ISO } from '../time';
import { TVirtualAccountId } from './account';
import { TAssetId } from './asset';
import { TInstrumentId } from './instrument';
...
export enum EPortfolioTradeSide {
    Buy = 'Buy',
    Sell = 'Sell',
    BuySell = 'BuySell',
}
