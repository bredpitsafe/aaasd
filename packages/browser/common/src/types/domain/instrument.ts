...
import { TAsset, TAssetId } from './asset';
import { EExchangeName } from './exchange';
import { TIndex, TIndexId } from './index';
...
export type TInstrumentSwapKind = {
    ...
    // SYNC WITH BACKEND
    buyInstrumnetName: TInstrument['name'];
    sellInstrumentId: TInstrumentId;
    // SYNC WITH BACKEND
    sellInstrumnetName: TInstrument['name'];
};
