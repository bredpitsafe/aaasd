...
function peg$parse(input: string, options?: IParseOptions) {
  ...
  const peg$c30 = "layout";
  const peg$c31 = peg$literalExpectation("layout", true);
  const peg$c32 = "auto";
  const peg$c33 = peg$literalExpectation("auto", true);
  const peg$c34 = "fixed";
  const peg$c35 = peg$literalExpectation("fixed", true);
  const peg$c36 = function(text: any): any { return { layout: text?.toLowerCase() }; };
  const peg$c37 = function(condition: any, parameters: any): any { return { condition, parameters: mergeParameters(parameters) }; };
  const peg$c38 = function(ifExpression: any): any { return ifExpression; };
  const peg$c39 = function(name: any): any { return wrap(name, 'name'); };
  const peg$c40 = function(args: any): any { return wrap(args, 'args'); };
  const peg$c41 = function(template: any): any { return processTableCellTemplate(template); };
  const peg$c42 = "grid";
  const peg$c43 = peg$literalExpectation("grid", true);
  const peg$c44 = function(grid: any): any { return { grid }; };
  const peg$c45 = function(grid: any): any { return processGridContent(grid); };
  const peg$c46 = "columns";
  const peg$c47 = peg$literalExpectation("columns", true);
  const peg$c48 = function(text: any): any { return processGridColumnsCount(text); };
  const peg$c49 = function(cell: any): any { return processGridCell(cell); };
  const peg$c50 = function(template: any): any { return processGridCellTemplate(template); };
  const peg$c51 = "if";
  const peg$c52 = peg$literalExpectation("if", true);
  const peg$c53 = function(key: any): any { return key; };
  const peg$c54 = "templates";
  const peg$c55 = peg$literalExpectation("templates", true);
  const peg$c56 = "template";
  const peg$c57 = peg$literalExpectation("template", true);
  const peg$c58 = "source";
  const peg$c59 = peg$literalExpectation("source", true);
  const peg$c60 = function(name: any, url: any): any { return processSource(name, url); };
  const peg$c61 = function(url: any, name: any): any { return processSource(name, url); };
  const peg$c62 = "url";
  const peg$c63 = peg$literalExpectation("url", true);
  const peg$c64 = function(url: any): any { return processRequiredValue(url, 'Source URL'); };
  const peg$c65 = "name";
  const peg$c66 = peg$literalExpectation("name", true);
  const peg$c67 = function(name: any): any { return processRequiredValue(name, 'Source name'); };
  const peg$c68 = "use-template";
  const peg$c69 = peg$literalExpectation("use-template", true);
  const peg$c70 = function(template: any): any { return template; };
  const peg$c71 = "use_template";
  const peg$c72 = peg$literalExpectation("use_template", true);
  const peg$c73 = function(name: any, args: any): any { return processTemplateUseContent(name, args); };
  const peg$c74 = function(args: any, name: any): any { return processTemplateUseContent(name, args); };
  const peg$c75 = function(name: any): any { return processRequiredValue(name, 'Template name'); };
  const peg$c76 = "parameters";
  const peg$c77 = peg$literalExpectation("parameters", true);
  const peg$c78 = function(args: any): any { return processTemplateArguments(args); };
  const peg$c79 = "parameter";
  const peg$c80 = peg$literalExpectation("parameter", true);
  const peg$c81 = function(argument: any): any { return processTemplateArgument(argument, 2); };
  const peg$c82 = function(argument: any): any { return processTemplateArgument(argument, 1); };
  const peg$c83 = "scope";
  const peg$c84 = peg$literalExpectation("scope", true);
  const peg$c85 = function(scope: any): any { return processScriptScope(scope); };
  const peg$c86 = "condition";
  const peg$c87 = peg$literalExpectation("condition", true);
  const peg$c88 = function(condition: any): any { return processConditionExpression(condition); };
  const peg$c89 = "style";
  const peg$c90 = peg$literalExpectation("style", true);
  const peg$c91 = function(styles: any): any { return processStyle(styles); };
  const peg$c92 = function(startTag: any, content: any, endTag: any): any { return processStyleItem(startTag, content, endTag); };
  const peg$c93 = function(startTag: any): any { return processEmptyStyleItem(startTag); };
  const peg$c94 = "tooltip";
  const peg$c95 = peg$literalExpectation("tooltip", true);
  const peg$c96 = function(tooltip: any): any { return processTooltip(tooltip); };
  const peg$c97 = function(value: any): any { return processDisplayValue(value); };
  const peg$c98 = function(parameters: any): any { return processFormattedText(parameters); };
  const peg$c99 = "format";
  const peg$c100 = peg$literalExpectation("format", true);
  const peg$c101 = function(format: any): any { return processFormat(format); };
  const peg$c102 = "formula";
  const peg$c103 = peg$literalExpectation("formula", true);
  const peg$c104 = function(formula: any): any { return processFormula(formula); };
  const peg$c105 = function(text: any): any { return processGridColumn(text); };
  const peg$c106 = "mark";
  const peg$c107 = peg$literalExpectation("mark", true);
  const peg$c108 = function(parameters: any): any { return processMark(parameters); };
  const peg$c109 = peg$otherExpectation("\"<\"");
  const peg$c110 = "<";
  const peg$c111 = peg$literalExpectation("<", false);
  const peg$c112 = peg$otherExpectation("\">\"");
  const peg$c113 = ">";
  const peg$c114 = peg$literalExpectation(">", false);
  const peg$c115 = peg$otherExpectation("\"/\"");
  const peg$c116 = "/";
  const peg$c117 = peg$literalExpectation("/", false);
  const peg$c118 = peg$otherExpectation("<![CDATA[");
  const peg$c119 = "<![CDATA[";
  const peg$c120 = peg$literalExpectation("<![CDATA[", false);
  const peg$c121 = peg$otherExpectation("]]>");
  const peg$c122 = "]]>";
  const peg$c123 = peg$literalExpectation("]]>", false);
  const peg$c124 = peg$otherExpectation("\"Tag name\"");
  const peg$c125 = /^[a-zA-Z]/;
  const peg$c126 = peg$classExpectation([["a", "z"], ["A", "Z"]], false, false);
  const peg$c127 = /^[\-_]/;
  const peg$c128 = peg$classExpectation(["-", "_"], false, false);
  const peg$c129 = /^[a-zA-Z0-9]/;
  const peg$c130 = peg$classExpectation([["a", "z"], ["A", "Z"], ["0", "9"]], false, false);
  const peg$c131 = function(): any { return text(); };
  const peg$c132 = peg$otherExpectation("\"Tag value\"");
  ...
  const peg$c135 = peg$otherExpectation("\"CDATA section\"");
  const peg$c136 = function(): any { return text()?.trim() ?? ''; };
  const peg$c137 = function(text: any): any { return text; };
  const peg$c138 = function(text: any): any { return text.trim() ?? ''; };
  const peg$c139 = peg$otherExpectation("\"Closing tag name\"");
  ...
  function peg$parseTableLayout(): any {
    let s0, s1, s2, s3, s4, s5, s6, s7;
  ...
  function peg$parseTableParameters(): any {
    let s0;

    s0 = peg$parseStyle();
    if (s0 as any === peg$FAILED) {
      s0 = peg$parseTableHeader();
      if (s0 as any === peg$FAILED) {
        s0 = peg$parseTableLayout();
      }
    }
