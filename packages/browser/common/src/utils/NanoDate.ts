...
import BaseNanoDate from 'nano-date';

import type { ISO, Microseconds, Milliseconds, Nanoseconds, Seconds } from '../types/time';
import { plus } from './math';
import { microseconds2nanoseconds, milliseconds2microseconds, seconds2milliseconds } from './time';

export class NanoDate extends BaseNanoDate {
    static from({
        unixSeconds,
        nanoseconds,
    }: {
