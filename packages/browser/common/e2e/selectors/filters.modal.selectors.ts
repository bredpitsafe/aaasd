...
export enum EFiltersModalSelectors {
    ...
    QuoteAssetsIncludeSelector = 'quoteAssetsIncludeSelector',
    ...
    QuoteAssetsExcludeSelector = 'quoteAssetsExcludeSelector',
...
export const EFiltersModalProps = {
    ...
    [EFiltersModalSelectors.QuoteAssetsIncludeSelector]: createTestProps(
    ...
    [EFiltersModalSelectors.QuoteAssetsExcludeSelector]: createTestProps(
