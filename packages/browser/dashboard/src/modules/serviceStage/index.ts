...
import { TSocketMap, TSocketName, TSocketStruct } from '@frontend/common/src/types/domain/sockets';
...
const createModule = () => {
    ...
    const currentStage$: Observable<TSocketStruct> = boxCurrentStageName.obs.pipe(
