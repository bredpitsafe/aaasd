...
import { TDragStartData, useDrag } from '@frontend/common/src/hooks/useDragAndDrop/useDrag';
import type { TWithClassname } from '@frontend/common/src/types/components';
import { cnFit } from '@frontend/common/src/utils/css/common.css';
import { useFunction } from '@frontend/common/src/utils/React/useFunction';
import cn from 'classnames';
import { isNil } from 'lodash-es';
import { cloneElement, Key, ReactElement, ReactNode, SyntheticEvent, useMemo, useRef } from 'react';
    ...
    return (
        <>
            ...
            <div ref={dragPreview} className={cnRoot}>
                <Tabs
                    {...createTestProps(EDashboardPageSelectors.Card)}
