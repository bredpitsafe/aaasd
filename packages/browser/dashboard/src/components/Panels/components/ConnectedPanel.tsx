...
import { PanelView, TPanelTab, TPanelViewProps } from '../../Panel/view';
...
export function ConnectedPanel({
    ...
    const { openModalFullDashboardEditor } = useModule(ModuleDashboardActions);
    ...
    const handleEdit = useFunction(async () => {
        await openModalFullDashboardEditor(generateTraceId(), dashboardItemKey, panel.panelId);
    });
