...
import { extractValidEnum } from '@frontend/common/src/utils/extract';
...
export async function convertImportableJsonToDashboard(
    ...
    if (validationResult !== true) {
        ...
        throw new ConvertError(message, validationResult);
    }
...
export function convertDashboardToXml(
    exportableDashboard: TExportableDashboardWrapped | TExportableDashboardEditorWrapped,
): TStorageDashboardConfig {
