import { fetchDashboardDraftEnvBox } from '@frontend/common/src/actors/DashboardsStorage/envelope';
...
export function fetchDashboardDraftFactory(
    ctx: TContextRef,
): (
                ...
                switchMap((stage) =>
                    fetchDashboardDraftEnvBox
                        ...
                        .pipe(
                            ...
                            logError(
                                'fetchServerDashboardDraft',
                                'Failed to fetch dashboard draft',
                            ),
