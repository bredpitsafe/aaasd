...
import {
    EHerodotusProtocolVersion,
    THerodotusTaskInstrumentView,
    THerodotusTaskView,
} from '../types';
import { EHerodotusTaskType, THerodotusTask, THerodotusTaskInstrument } from '../types/domain';
...
export function getHerodotusTaskViewItem(
    ...
    return {
        ...
        robotId,
        priceLimitView:
            task.taskType === EHerodotusTaskType.BuySell
                ? null
...
function mapInstrumentToView(
    ...
    side: EHerodotusTaskType.Buy | EHerodotusTaskType.Sell,
    useUsd: boolean,
