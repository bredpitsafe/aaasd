...
type TStatusRendererParams = ICellRendererParams<THerodotusTaskView> & {
...
export const TaskStatusRenderer = memo((params: TStatusRendererParams): ReactElement | null => {
    const { data, onStart, onPaused, onSave, onReset } = params;
