...
import { ModuleSubscribeToIndicatorsUpdates } from '@frontend/common/src/modules/actions/indicators/snapshot';
...
function createModule(ctx: TContextRef) {
    ...
    const subscribeToIndicatorsUpdates = ModuleSubscribeToIndicatorsUpdates(ctx);
        ...
        (
            ...
            return allInstruments$.pipe(
                ...
                scan((hash, event) => {
                    ...
                    return hash.modify(event.payload);
