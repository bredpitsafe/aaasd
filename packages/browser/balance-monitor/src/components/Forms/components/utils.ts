import { KeyByType } from '@frontend/common/src/types';
import type {
    TCoinId,
    TFullInfoByCoin,
    TRuleAccounts,
...
import { TAccountInfo, TTransfer } from '@frontend/common/src/types/domain/balanceMonitor/defs';
...
import { TRuleCommonFormData } from './defs';
