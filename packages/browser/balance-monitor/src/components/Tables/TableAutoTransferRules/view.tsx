...
import type { TAutoTransferRulesDescriptor } from '../../../modules/observables/ModuleAutoTransferRules';
...
export const TableAutoTransferRules = memo(
    ({
        ...
        const autoTransferRules = useMemo(
            () =>
                isSyncDesc(autoTransferRulesDescriptor)
        ...
        useGridOverlay(
            gridApi,
            isUnscDesc(autoTransferRulesDescriptor)
