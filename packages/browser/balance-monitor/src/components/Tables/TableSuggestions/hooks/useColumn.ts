...
import { TCoinId } from '@frontend/common/src/types/domain/balanceMonitor/defs';
...
import { MakeTransferRenderer } from '../components/MakeTransferRenderer';
import { ResetCellRenderer } from '../components/ResetCellRenderer';
import {
    EAmountNotification,
    EPlainSuggestionGroup,
    ...
    return useMemo(
        () => [
            ...
            },
            {
                ...
                cellRenderer: accountCellRendererFactory<TPlainSuggestion>('sourceExchange'),
            ...
            },
            {
                ...
                cellEditorPopup: true,
                valueGetter: (params) => params.data?.destination,
                cellRenderer: accountCellRendererFactory<TPlainSuggestion>('destinationExchange'),
            ...
            },
            {
                ...
                valueGetter: usdTransferAmountGetter,
                comparator: amountComparator,
...
function usdTransferAmountGetter(params: ValueGetterParams<TPlainSuggestion>): TAmount {
    if (isNil(params.data)) {
        return 0 as TAmount;
    }
    ...
    return getQuoteAmount(amount, convertRate, CONVERSION_DIGITS);
}
