...
import type { TAmountLimitsRulesDescriptor } from '../../../modules/observables/ModuleAmountLimitsRules';
...
export const TableAmountLimitsRules = memo(
    ({
        ...
        const amountLimitsRules = useMemo(
            () =>
                isSyncDesc(amountLimitsRulesDescriptor)
        ...
        useGridOverlay(
            gridApi,
            isUnscDesc(amountLimitsRulesDescriptor)
