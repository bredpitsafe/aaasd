...
export enum EInternalTransfersHistoryTableSelectors {
    ...
    MainAccountRowText = `${ETableBodySelectors.TableBody} [col-id="mainAccount.account"]`,
    SourceRowText = `${ETableBodySelectors.TableBody} [col-id="source.name"]`,
    DestinationRowText = `${ETableBodySelectors.TableBody} [col-id="destination.name"]`,
