...
class BacktestingPage extends BasePage {
    ...
    checkVisibleProductLogsTab(): void {
        ...
        for (const value of ['Time UTC', 'Level', 'Component', 'Message']) {
    ...
    checkNotDataIndicatorsTab(): void {
        this.indicatorsTab.get().contains('No Rows To Show', { timeout: 60000 });
    }

    checkNotDataProductLogsTab(): void {
        this.productLogsTab.get().contains('No Rows To Show', { timeout: 60000 });
    }
}
