Feature: e2e tests: "Balance Monitor" page test suit. I as User checks the functionality of "Balance Monitor" page
  ...
  Scenario: Checking the visibility of the graph in the "Distribution" tab
    ...
    And user sees the "Balance Monitor" page
    And user closes all tabs on the "Balance Monitor" page
    When user opens the "Distribution" tab
    And user sees the "Distribution" tab in the "Balance Monitor" page
    And user selects a coin "AAA" from the "Distribution"
  ...
  Scenario Outline: "Send data to analyse" tab. Checking the functionality of the "Clear" button
    ...
    And user sees the "Balance Monitor" page
    And user closes all tabs on the "Balance Monitor" page
    When user opens the "Send data to analyse" tab
  ...
  Scenario Outline: "Gathering" tab. Checking the coin display on the button
    ...
    And user sees the "Balance Monitor" page
    And user closes all tabs on the "Balance Monitor" page
    When user opens the "Gathering" tab
  ...
  @clearIndexedDb
  Scenario Outline: "Gathering" tab. Checking the functionality of the "<NameButton>" button in the in the "Stop Gathering confirmation" modal
    Given user goes to the "Balance Monitor" page with the backend server parameter
    And user sees the "Authorization" page and logs in as a "Frontend" user
    And user sees the "Balance Monitor" page
    And user closes all tabs on the "Balance Monitor" page
  ...
  @clearIndexedDb
  Scenario Outline: "Gathering" tab. Checking the functionality of the "<NameButton>" button in the in the "Start Gathering confirmation" modal
    Given user goes to the "Balance Monitor" page with the backend server parameter
    And user sees the "Authorization" page and logs in as a "Frontend" user
    And user sees the "Balance Monitor" page
    And user closes all tabs on the "Balance Monitor" page
