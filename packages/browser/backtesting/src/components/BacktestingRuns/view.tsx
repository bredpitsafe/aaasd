...
import { TableBacktestingRuns, TTableBacktestingRunsProps } from '../TableBacktestingRuns/view';
...
type TBacktestingRunsProps = TWithClassname &
    TTableBacktestingRunsProps & {
        ...
        onUpdateScoreIndicatorsList: (scoreIndicatorsList: string[]) => Promise<unknown>;
    };
