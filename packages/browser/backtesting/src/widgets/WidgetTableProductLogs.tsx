...
import type { TProductLogSubscriptionFilters } from '@frontend/common/src/handlers/productLogs/defs';
...
export const WidgetTableProductLogs = memo(({ className }: { className?: string }) => {
    ...
    console.log('>>', waitInitializeStates, waitRequiredStates);
    return (
        <div className={cn(cnRelative, className)}>
            <ValueDescriptorsBadge descriptors={[run, task]} />
