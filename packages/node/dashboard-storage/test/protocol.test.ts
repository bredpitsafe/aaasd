...
import { generateTraceId } from '../src/utils/traceId/index.ts';
import { BASE_URL, Client, users, WS_ADDRESS } from './client/index.js';
...
describe('Protocol', () => {
    ...
    it('healthcheck', async () => {
        const response = await fetch(`http://${BASE_URL}${config.service.healthcheckURL}`);
