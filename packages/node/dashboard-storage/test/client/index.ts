import usersList from '@bhft/oauth-mock-server/data/users.json';
import { isNil, keyBy } from 'lodash-es';
import { firstValueFrom, Observable, Subscriber } from 'rxjs';
import WebSocket from 'ws';

import { Response } from '../../src/def/response.js';
import { generateTraceId } from '../../src/utils/traceId/index.js';
