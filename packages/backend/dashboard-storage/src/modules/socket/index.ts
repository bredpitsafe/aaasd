import { generateCorrelationId, TCorrelationId } from '@backend/utils/src/correlationId.ts';
import { generateTraceId, TraceId } from '@backend/utils/src/traceId/index.ts';
...
const send = (params: TSendParams) => {
    ...
    logger.debug({
        ...
        correlationId: params.correlationId as TCorrelationId,
...
export const handleMessage = (socketKey: TActorSocketKey, data: WebSocket.Data) => {
    try {
        ...
        const actorRequest: TActorRequest = {
            ...
            correlationId: req.correlationId as TCorrelationId,
            payload: req.payload,
        };
