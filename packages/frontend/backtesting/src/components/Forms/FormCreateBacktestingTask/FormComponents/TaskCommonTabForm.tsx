...
import { DisabledTime } from 'rc-picker/es/interface';
import { memo } from 'react';

import { EFieldName, TFormBacktestingTask, TFormCreateBacktestingTaskProps } from '../defs';
import {
    cnConfigEditor,
            ...
            <div className={cnRoot}>
                <div className={cnCol}>
                    ...
                    <Space size="middle" wrap align="start" className={cnScoreDateContainer}>
                        ...
                        <FormikForm.Item
                            name="simulationInverval"
                            label="Simulation interval (UTC)"
                        >
