...
import { LinkedMap, TLinkedMap } from '@frontend/common/src/utils/LinkedMap';
...
import { POINT_ITEM_SIZE, TPart, TPartId, TPartPointBuffer } from '../../../../lib/Parts/def';
...
export class PartsTextureStore {
    ...
    constructor(
        ...
        LinkedMap.forEach(this.state.parts, ({ value }) => {
            this.setPart(preparePart(value));
        });
    }
    ...
    private insertPartToTree(part: TPart) {
        ...
        if (process.env.NODE_ENV === 'development') {
            ...
            if (parts.length > 1) {
                console.error('Duplicated parts', parts);
            }
        }
    }
