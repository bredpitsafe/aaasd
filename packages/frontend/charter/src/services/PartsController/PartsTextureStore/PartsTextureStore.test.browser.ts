...
import { getRandomFloat64, getRandomIntInclusive } from '@frontend/common/src/utils/random';
...
import { createPart, createPartBuffer } from '../../../../lib/Parts/utils/part';
...
describe('PartsTextureStore', () => {
    ...
    it('Should correct free up place for new parts', () => {
        ...
        const lastPart = createPart<TPart>({
            seriesId: seriesId,
