...
class ManualTransferTab {
    ...
    readonly coinSelector = new SelectVirtualList(EManualTransferTabSelectors.CoinSelector);
    readonly sourceSelector = new SelectVirtualList(EManualTransferTabSelectors.SourceSelector);
    readonly destinationSelector = new SelectVirtualList(
        EManualTransferTabSelectors.DestinationSelector,
    );
    readonly availableSelector = new SelectVirtualList(
