...
class ConfigTab {
    ...
    readonly revisionsListItem = new Selector(EConfigTabSelectors.RevisionsListItem, false);
    ...
    readonly configOriginalText = new Text(EConfigTabSelectors.ConfigOriginalText, false);
    readonly configDiffText = new Text(EConfigTabSelectors.ConfigDiffText, false);
    ...
    readonly loadingRevisions = new Text(EConfigTabSelectors.LoadingRevisions, false);
    ...
    checkVisibleIcon(): void {
        this.saveIcon.get().first().should('be.visible');
        this.saveIcon.get().last().should('be.visible');
    }

    checkNotVisibleIcon(): void {
        this.saveIcon.checkNotExists();
    }
