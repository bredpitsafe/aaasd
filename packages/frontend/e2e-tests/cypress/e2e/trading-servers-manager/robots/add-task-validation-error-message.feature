Feature: e2e tests: "TSM" page test suit. I as User checks the functionality validation of "Add Task" tap of the "Herodotus" robot
  ...
  Scenario Outline: "Herodotus" robot. "Add Task" tab. Checking the visibility of the "<NameInput>" input error message
    ...
    Examples:
      ...
      | Buy      | BTC           | 1           | BinanceSpot  | hero.bn     | BTCEUR         | 5             | 1           | Total Amount | Amount should be greater then 0       |
      | Buy      | BTC           | 1           | BinanceSpot  | hero.bn     | BTCEUR         | 5             | 1           | Order Amount | Order Amount should be greater then 0 |
      | Buy      | BTC           | 1           | BinanceSpot  | hero.bn     | BTCEUR         | 5             | 1           | Max Price    | Max Price should be greater then 0    |
