...
Given(`user selects internal transfer type values:`, (dataTable: DataTable) => {
    dataTable.hashes().forEach((element) => {
        internalTransfersTab.accountSelector.clickAndType(element.account);
        internalTransfersTab.fromToSelector.clickAndTypeFirst(element.from);
        internalTransfersTab.fromToSectionSelector.clickAndTypeFirst(element.fromSection);
        internalTransfersTab.fromToSelector.clickAndType(element.to);
        internalTransfersTab.fromToSectionSelector.clickAndType(element.toSection);
        internalTransfersTab.coinSelector.clickAndType(element.coin);
...
Given(`user sees that "Coin" selector has set value {string}`, (nameCoin: string) => {
    internalTransfersTab.coinSelector.clickAndType(nameCoin);
