...
Given(
    ...
    (checkContain: string, nameAccount: string) => {
        switch (checkContain) {
            case 'sees':
                commonRuleTab.exchangeSelector.firstClick();
...
Given(
    ...
    (checkContain: string, nameAccount: string) => {
        switch (checkContain) {
            case 'sees':
                commonRuleTab.exchangeSelector.lastClick();
                commonRuleTab.exchangeSelector.checkListContainText(nameAccount);
                break;
            case 'not sees':
                commonRuleTab.exchangeSelector.lastClick();
...
Given(
    ...
    (checkContain: string, nameAccount: string) => {
        switch (checkContain) {
            case 'sees':
                commonRuleTab.accountSelector.firstClick();
...
Given(
    ...
    (checkContain: string, nameAccount: string) => {
        switch (checkContain) {
            case 'sees':
                commonRuleTab.accountSelector.lastClick();
                commonRuleTab.accountSelector.checkListContainText(nameAccount);
                break;
            case 'not sees':
                commonRuleTab.accountSelector.lastClick();
