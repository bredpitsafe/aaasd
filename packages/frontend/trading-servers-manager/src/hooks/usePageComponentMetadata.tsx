...
import {
    TStatusMessage,
    useStatusMessageHistory,
} from '@frontend/common/src/components/hooks/components/useStatusMessageHistory';
import { ComponentTabKey, TScrollData } from '@frontend/common/src/types/componentMetadata';
