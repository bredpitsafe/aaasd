...
import type { TInternalTransfersInfo } from '@frontend/common/src/types/domain/balanceMonitor/defs';
...
const descriptor = createRemoteProcedureDescriptor<TEmptySendBody, TReceiveBody>()(
    EPlatformSocketRemoteProcedureName.SubscribeToInternalTransfersCapabilities,
    ERemoteProcedureType.Subscribe,
);

export const ModuleSubscribeToInternalTransfersCapabilities = createRemoteProcedureCall(descriptor)(
    {
        getPipe: () =>
            convertToSubscriptionEventValueDescriptor((payload) => payload.possibleTransfers),
    },
);
