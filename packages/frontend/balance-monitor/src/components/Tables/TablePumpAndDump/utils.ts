...
import type { Minutes, Seconds } from '@frontend/common/src/types/time';
import { minutes2hours, seconds2minutes } from '@frontend/common/src/utils/time';
import { isNil } from 'lodash-es';

import type { TPumpDumpInfo } from '../../../modules/observables/ModulePumpDumpInfo';
