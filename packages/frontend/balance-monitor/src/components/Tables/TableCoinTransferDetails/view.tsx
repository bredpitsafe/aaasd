...
import { isSyncDesc, matchDesc } from '@frontend/common/src/utils/ValueDescriptor';
import cn from 'classnames';
import { isUndefined } from 'lodash-es';
import { memo, useMemo } from 'react';

import type { TCoinInfoDescriptor } from '../../../modules/observables/ModuleCoinInfo';
import type { TCoinTransferDetailsDescriptor } from '../../../modules/observables/ModuleCoinTransferDetails';
        ...
        const coinTransferDetails = useMemo(
            () =>
                isUndefined(selectedCoin)
                    ? EMPTY_ARRAY
                    : matchDesc(coinTransferDetailsDescriptor, {
                          idle() {
                              return undefined;
                          },
                          unsynchronized() {
                          ...
                          synchronized(items): TCoinTransferDetailsWithId[] {
                              return items.map((details) => ({
                                  ...
                                  ...details,
                                  convertRate: isSyncDesc(convertRatesDescriptor)
