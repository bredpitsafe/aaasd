...
import type { TTransfersBlockingRulesDescriptor } from '../../../modules/observables/ModuleTransferBlockingRules';
...
export const TableTransferBlockingRules = memo(
    ({
        ...
        const transferBlockingRules = useMemo(
            () =>
                isSyncDesc(transferBlockingRulesDescriptor)
        ...
        useGridOverlay(
            gridApi,
            isUnscDesc(transferBlockingRulesDescriptor)
