...
type TUseContextMenuItemsProps = {
    deleteDashboard: (dashboardItemKey: TDashboardItem) => Promise<unknown>;
    persistDashboard: (dashboardItemKey: TDashboardItem) => Promise<unknown>;
    revertDashboard: (dashboardItemKey: TDashboardItem) => Promise<unknown>;
    cloneDashboard: (dashboardItemKey: TDashboardItem) => Promise<unknown>;
    shareDashboard: (dashboardItemKey: TDashboardItem) => Promise<unknown>;
    copyDashboardURL: (dashboardItemKey: TDashboardItem) => Promise<unknown>;
