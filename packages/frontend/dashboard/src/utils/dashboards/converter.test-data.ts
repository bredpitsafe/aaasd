...
import type { DeepPartial } from '@frontend/common/src/types';
import type {
...
import { ETableLayout } from '@frontend/common/src/utils/CustomView/parsers/defs';
  ...
  <panels>
    ...
    <panel>
      ...
      <table>
        <style>
          <width>auto</width>
          <background_color>AntiqueWhite</background_color>
        </style>
        <if>
          <condition>age({ALGO|TEST_RND|01}) > 265130</condition>
          <style>
            <background_color>Beige</background_color>
          </style>
        </if>
        <layout>auto</layout>
        <header>
...
const WithoutTypeDashboard: DeepPartial<TDashboard> = {
    ...
    panels: [
        ...
        },
        {
            ...
            table: {
                style: { width: 'auto', backgroundColor: 'AntiqueWhite' },
                if: {
                ...
                header: {
                    column: [
                        { text: 'Header2.0', width: '100px' },
                        { width: '200px' },
                        { text: 'Header3', width: '100px' },
                        { text: 'Header4', width: '100px' },
                    ],
                },
                row: {
