import { fetchComponentStateProcedureDescriptor } from '../../../actors/TradingServersManager/descriptors.ts';
...
export type TComponentStateDescriptor = TValueDescriptor2<string>;

export const ModuleGetComponentState = createRemoteProcedureCall(
