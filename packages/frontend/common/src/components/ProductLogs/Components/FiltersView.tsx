...
} from '../../../handlers/productLogs/defs';
import { TimeZone, TimeZoneList } from '../../../types/time';
                    ...
                    <FormikForm className={cnForm} layout="vertical" size="small">
                        <div className={cnRow}>
                            <FormikForm.Item
                                ...
                                name="since"
                                label={
                                    props.timeZone === TimeZoneList.UTC ? 'Since (UTC)' : 'Since'
                                }
                            >
                                <FormikDatePicker
                            ...
                            <FormikForm.Item
                                className={cnLastItem}
                                name="till"
                                label={props.timeZone === TimeZoneList.UTC ? 'Till (UTC)' : 'Till'}
                            >
                                <FormikDatePicker
