...
import { RowClassParams, RowClassRules } from '@frontend/ag-grid';
import cn from 'classnames';
import { ReactElement, useMemo } from 'react';

import { EProductLogLevel, TProductLog } from '../../../handlers/productLogs/defs';
import { ETableIds } from '../../../modules/clientTableFilters/data';
import type { TWithClassname } from '../../../types/components';
import { EDateTimeFormats, ISO, Milliseconds, TimeZone, TimeZoneList } from '../../../types/time';
...
function createColumns(timeZone: TimeZone): ColDef<TDataType>[] {
    return [
        {
            field: 'platformTime',
            headerName: timeZone === TimeZoneList.UTC ? 'Time UTC' : 'Time',
