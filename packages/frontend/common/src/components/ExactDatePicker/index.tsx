...
import { EDateTimeFormats, ISO, Seconds, TimeZone } from '../../types/time';
import { NanoDate } from '../../utils/NanoDate';
import { useFunction } from '../../utils/React/useFunction';
import { formatNanoDate, getPlatformTimeValues } from '../../utils/time';
...
export function ExactDatePicker(props: TExactDatePickerProps): ReactElement {
    ...
    const cbInputRender = useFunction((props: InputHTMLAttributes<HTMLInputElement>) => {
        return (
            <Input
                {...createTestProps(ETableTabFilterSelectors.DataInput)}
                // @ts-ignore
                ref={props.ref}
