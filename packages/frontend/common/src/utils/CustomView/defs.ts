...
export type TStyle = {
    styleConverter?: string; // Conditional style
    inlineStyle?: Properties; // This is constant style
    inlineScheme?: TUnnamedScheme;
};
...
export type TUnnamedScheme = Omit<TScheme, 'name'>;
