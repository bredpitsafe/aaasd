import { THerodotusConfigInstrumentV1, THerodotusConfigV1 } from '../types/v1/taskConfig';
import { THerodotusConfigInstrumentV2, THerodotusConfigV2 } from '../types/v2/taskConfig';
